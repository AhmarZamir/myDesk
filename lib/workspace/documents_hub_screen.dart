...
class _DocumentsHubScreenState extends State<DocumentsHubScreen> {
  ...
  Future<void> _open(Map<String, dynamic> doc) async {
    try {
      ...
      if (!opened) _message('Could not open file.');
    } catch (e) {
          ...
          Wrap(
            ...
            children: [
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text('Browse and manage documents without leaving this workspace.', style: TextStyle(color: Theme.of(context).colorScheme.onSurfaceVariant)),
              ]),
                ...
                SingleChildScrollView(
                  ...
                  child: Wrap(
                    ...
                    children: filters.entries
                        .map((e) => ChoiceChip(label: Text(e.value), selected: _filter == e.key, onSelected: (_) => setState(() => _filter = e.key)))
                        .toList(),
                  ),
                ),
                const SizedBox(height: 18),
                if (visible.isEmpty)
                  const Card(child: Padding(padding: EdgeInsets.all(34), child: Center(child: Text('No documents in this section.')))),
                ...visible.map((doc) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      trailing: PopupMenuButton<String>(
                        ...
                        itemBuilder: (_) => [
                          const PopupMenuItem(value: 'open', child: ListTile(contentPadding: EdgeInsets.zero, leading: Icon(Icons.open_in_new), title: Text('Open'))),
                          if (mine)
